...
Original file is located at
    https://colab.research.google.com/drive/15oVP2HGkmRxSbYSZZ_uwQkDJJG_vEyKN
...
def check_range(x, y, z):
  if (x in range(y,z)):
    return f'{x} jest między {y} i {z} '
  else :
    return f'{x} NIE jest między {y} i {z}'
